...
| Q-014 | PARTIAL | What signed manifest/source-bundle design will protect firmware distribution? | Supply-chain and revocation gate | ADR-0014 fixes the wire/trust design and byte gate; ADR-0015 proves bounded parsing and untrusted Synthetic verification; ADR-0016 proves Synthetic dual-threshold rotation, key removal, expiry, and unpersisted rollback transitions. Initial root ceremony/admission, atomic store, source bundle, and end-to-end release prototype remain |
